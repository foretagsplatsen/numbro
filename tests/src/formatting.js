...
exports.formatting = {
	...
	formatByte: (test) => {
		let data = [
			...
			[[10 ** 3, {base: 'decimal'}], '1KB'],
			[[2 * 10 ** 3, {base: 'decimal'}], '2KB'],
			[[10 ** 6, {base: 'decimal'}], '1MB'],
			[[10 ** 9, {base: 'decimal'}], '1GB'],
			[[10 ** 12, {base: 'decimal'}], '1TB'],

			[[2 ** 10, {base: 'general'}], '1KB'],
			[[2 * 2 ** 10, {base: 'general'}], '2KB'],
			[[2 ** 20, {base: 'general'}], '1MB'],
			[[2 ** 30, {base: 'general'}], '1GB'],
			[[2 ** 40, {base: 'general'}], '1TB'],
		];
